...
export class SelfHealingManager {
  async healNavigation(page: Page, url: string): Promise<boolean> {
  ...
  private async handlePopups(page: Page): Promise<boolean> {
  ...
  async healElementSelector(page: Page, selector: string): Promise<boolean> {
  ...
  async healClick(page: Page, selector: string): Promise<boolean> {
  ...
  async healType(page: Page, selector: string, text: string): Promise<boolean> {
