...
export class REEngineClient {
  ...
  async queryApprovals(filter: ApprovalFilter = {}): Promise<PaginatedResponse<Approval>> {
    ...
    try {
      ...
      const response = this.createResponse(requestId, startTime, true, result.data) as PaginatedResponse<Approval>;
  ...
  async queryLeads(filter: LeadFilter = {}): Promise<PaginatedResponse<Lead>> {
    ...
    try {
      ...
      const response = this.createResponse(requestId, startTime, true, result.data) as PaginatedResponse<Lead>;
