...
import { createREEngineClient } from '../../sdk/client/reengine-client.js';
...
describe('Ollama Integration', () => {
    ...
    it('should generate AI response for conversation', async () => {
        ...
        const response = await client.generateResponse(testLead, conversationHistory, 'What 3-bedroom houses do you have available?', {
            tone: 'friendly',
...
//# sourceMappingURL=ollama-integration.test.js.map