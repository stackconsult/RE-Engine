...
export class LiteLLMProxyService {
    ...
    async initialize() {
        try {
            ...
            logError(error, 'litellm-proxy-init-failed');
            throw error;
        }
    }
    async startProxy() {
        try {
            ...
            logError(error, 'litellm-proxy-start-failed');
            throw error;
        }
    }
    async stopProxy() {
        try {
            ...
            logError(error, 'litellm-proxy-stop-failed');
            throw error;
        }
    }
    async restartProxy() {
    ...
    async healthCheck() {
        try {
            ...
            logError(error, 'litellm-proxy-health-check-failed');
            this.status.error = error.message;
            return false;
        }
    }
    async getModelMapping(claudeModelName) {
        const mapping = this.config.modelMappings.find(m => m.claudeModelName === claudeModelName);
        if (!mapping) {
    ...
    async listAvailableModels() {
        try {
            ...
            logError(error, 'litellm-proxy-list-models-failed');
            return [];
        }
    }
    getStatus() {
    ...
    async generateConfigFile() {
        try {
            ...
            logError(error, 'litellm-proxy-config-failed');
            throw error;
        }
    }
    async waitForProxy() {
...
//# sourceMappingURL=litellm-proxy.service.js.map