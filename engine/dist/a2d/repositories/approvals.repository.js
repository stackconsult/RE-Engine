...
export class ApprovalsRepository {
    ...
    async query(filter = {}) {
        try {
            const result = await this.csv.read(this.filename);
            if (!result.success) {
...
//# sourceMappingURL=approvals.repository.js.map