...
import { BaseError, ValidationError, DatabaseError, AuthenticationError, AuthorizationError, NotFoundError, ConflictError, ExternalServiceError, TimeoutError, RateLimitError, ErrorHandler, isServiceError } from '../../src/util/error-handler.js';
    ...
    describe('ErrorHandler Utility', () => {
        ...
        it('should handle operation errors correctly', async () => {
            ...
            try {
                ...
                assert.equal(error.context?.operation, 'test-failure');
            }
        });
